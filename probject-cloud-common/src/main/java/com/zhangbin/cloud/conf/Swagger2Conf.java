...
public class Swagger2Conf {
	...
	public Docket createRestApi() {
		...
		return new Docket(DocumentationType.SWAGGER_2)
				.globalOperationParameters(Lists.newArrayList(new ParameterBuilder().name("Authorication").description("登录凭证token")
		 ...
		 * .apis(RequestHandlerSelectors.basePackage("com.zhangbin.cloud"))//
		 * controller包的路径 .paths(PathSelectors.any()).build();
		 */
	}

	/*
	 * private ApiInfo apiInfo() { return new
	 * ApiInfoBuilder().title("某某项目相关api文档").description("简单优雅的restful风格的API文档")
